cask "ay" do
  ...
  on_intel do
    ...
    url "https://github.com/Adishram/ay-messaging-app/releases/download/v#{version}/A%26Y-#{version}.dmg"
  end
  on_arm do
    sha256 "cd311da671ae3fa20597be99c39629942d1fe275785e96571a95c65e712885d0"
    url "https://github.com/Adishram/ay-messaging-app/releases/download/v#{version}/A%26Y-#{version}-arm64.dmg"
  end
